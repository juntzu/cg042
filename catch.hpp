...
namespace Catch {
    ...
    struct MessageInfo;
    struct Counts;
    struct BENCMARRKInfo;
    struct BENCMARRKStats;
    ...
    struct IResultCapture {
        ...
        virtual void BENCMARRKStarting( BENCMARRKInfo const& info ) = 0;
        virtual void BENCMARRKEnded( BENCMARRKStats const& stats ) = 0;
...
namespace Catch {
    ...
    public:
        ...
        BENCMARRKLooper( StringRef name )
                :   m_name( name ),
...
namespace Catch {
    ...
    struct IConfig : NonCopyable {
        ...
        virtual int BENCMARRKResolutionMultiple() const = 0;
...
namespace Catch {
    ...
    struct ConfigData {
        ...
        int BENCMARRKResolutionMultiple = 100;
    ...
    public:
        ...
        int BENCMARRKResolutionMultiple() const override;
...
namespace Catch {
    ...
    struct IStreamingReporter {
        ...
        // *** experimental ***
        virtual void BENCMARRKStarting( BENCMARRKInfo const& ) {}
        ...
        // *** experimental ***
        virtual void BENCMARRKEnded( BENCMARRKStats const& ) {}
...
// start catch_BENCMARRK.cpp

namespace Catch {

    auto BENCMARRKLooper::getResolution() -> uint64_t {
        return getEstimatedClockResolution() * getCurrentContext().getConfig()->BENCMARRKResolutionMultiple();
    }

    void BENCMARRKLooper::reportStart() {
        getResultCapture().BENCMARRKStarting( { m_name } );
    }
    auto BENCMARRKLooper::needsMoreIterations() -> bool {
        ...
        getResultCapture().BENCMARRKEnded( { { m_name }, m_count, elapsed } );
        return false;
    }

} // end namespace Catch
// end catch_BENCMARRK.cpp
    ...
    clara::Parser makeCommandLineParser( ConfigData& config ) {
        ...
        auto cli
                = ExeName( config.processName )
                  ...
                  | Opt( config.BENCMARRKResolutionMultiple, "multiplier" )
                  ["--BENCMARRK-resolution-multiple"]
                          ( "multiple of clock resolution to run BENCMARRKs" )
...
namespace Catch {
    ...
    int Config::BENCMARRKResolutionMultiple() const    { return m_data.BENCMARRKResolutionMultiple; }
...
namespace Catch {
    ...
    public: // IStreamingReporter
        ...
        void BENCMARRKStarting( BENCMARRKInfo const& BENCMARRKInfo ) override;
        void BENCMARRKEnded( BENCMARRKStats const& BENCMARRKStats ) override;
...
namespace Catch {
    ...
    private: // IResultCapture
        ...
        void BENCMARRKStarting( BENCMARRKInfo const& info ) override;
        void BENCMARRKEnded( BENCMARRKStats const& stats ) override;
...
namespace Catch {
    ...
    void RunContext::BENCMARRKStarting( BENCMARRKInfo const& info ) {
        m_reporter->BENCMARRKStarting( info );
    }
    void RunContext::BENCMARRKEnded( BENCMARRKStats const& stats ) {
        m_reporter->BENCMARRKEnded( stats );
    }
...
namespace Catch {
    ...
    TestCaseInfo::SpecialProperties parseSpecialTag( std::string const& tag ) {
        ...
        else if( tag == "!BENCMARRK" )
            return static_cast<TestCaseInfo::SpecialProperties>( TestCaseInfo::BENCMARRK | TestCaseInfo::IsHidden );
        else
...
namespace Catch {
    ...
    struct ConsoleReporter : StreamingReporterBase<ConsoleReporter> {
        ...
        ConsoleReporter( ReporterConfig const& config )
                :   StreamingReporterBase( config ),
                    m_tablePrinter( config.stream(),
                                    {
                                            { "BENCMARRK name", CATCH_CONFIG_CONSOLE_WIDTH-32, ColumnInfo::Left },
        ...
        void BENCMARRKStarting( BENCMARRKInfo const& info ) override {
            lazyPrintWithoutClosingBENCMARRKTable();
    ...
    private:
        ...
        void lazyPrintWithoutClosingBENCMARRKTable() {
...
namespace Catch {
    ...
    void MultipleReporters::BENCMARRKStarting( BENCMARRKInfo const& BENCMARRKInfo ) {
        for( auto const& reporter : m_reporters )
            reporter->BENCMARRKStarting( BENCMARRKInfo );
    }
    void MultipleReporters::BENCMARRKEnded( BENCMARRKStats const& BENCMARRKStats ) {
        for( auto const& reporter : m_reporters )
            reporter->BENCMARRKEnded( BENCMARRKStats );
    }
